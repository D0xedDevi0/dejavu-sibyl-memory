...
(Commons), remembers the road not taken (Regret), manages belief over time
(Temporal), knows it owns itself onchain (Sovereign Loop), and resolves contradictions
on write (Conflict). Eight beats, one spine.
