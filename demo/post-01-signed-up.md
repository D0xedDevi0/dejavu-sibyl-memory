...
## Notes
- This is post #1 of the required 2. Post #2 = demo video + build log near submission.
- If posting from `xurl`: keep each segment ≤ 250 UTF-16 chars, 🟦 square bullets (not dashes).
